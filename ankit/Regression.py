...
def adaRegressor(X, y, cv_size = 5):
...
print('(r2 on training): ', ada.score(X_train, y_train))
print('(MAE on train): ', mean_absolute_error(ada.predict(X_train), y_train))
print('(MSE on train): ', mean_squared_error(ada.predict(X_train), y_train))
print('(MAE on test): ', mean_absolute_error(ada.predict(X_test), y_test))
print('(MSE on test): ', mean_squared_error(ada.predict(X_test), y_test))
